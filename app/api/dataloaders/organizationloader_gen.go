...
type OrganizationLoaderConfig struct {
	...
	Fetch func(keys []int64) ([]*models.Organization, []error)
...
type OrganizationLoader struct {
	...
	cache map[int64]*models.Organization
...
func (l *OrganizationLoader) Load(key int64) (*models.Organization, error) {
...
func (l *OrganizationLoader) LoadThunk(key int64) func() (*models.Organization, error) {
	l.mu.Lock()
...
func (l *OrganizationLoader) LoadAll(keys []int64) ([]*models.Organization, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *OrganizationLoader) LoadAllThunk(keys []int64) func() ([]*models.Organization, []error) {
	results := make([]func() (*models.Organization, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *OrganizationLoader) Prime(key int64, value *models.Organization) bool {
	l.mu.Lock()
	var found bool
...
func (l *OrganizationLoader) Clear(key int64) {
	l.mu.Lock()
	delete(l.cache, key)
	l.mu.Unlock()
}

func (l *OrganizationLoader) unsafeSet(key int64, value *models.Organization) {
	if l.cache == nil {
		l.cache = map[int64]*models.Organization{}
	}
	l.cache[key] = value
}
...
func (b *organizationLoaderBatch) keyIndex(l *OrganizationLoader, key int64) int {
